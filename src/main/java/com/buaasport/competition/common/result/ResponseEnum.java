...
public enum ResponseEnum {
    ...
    LOGIN_USERNAME_NOTEXIST_ERROR(208, "用户不存在"),
    LOGIN_PASSWORD_ERROR(209, "密码错误"),
    USERID_NULL_ERROR(210, "用户ID为空"),
    LOGIN_AUTH_ERROR(-211, "未登录"),
    EMAIL_NULL_ERROR(-301, "邮箱不能为空"),
    ...
    TEAMNAME_EXIST_ERROR(304, "团队名已存在"),
    TEAMNAME_NULL_ERROR(305, "当团队名不能为空"),
